...
class XLMStorageReaderTest {

    private XLMStorageReader xlmStorageReader;
    private XLMPropertiesReaderData data;


    @BeforeEach
    void setUp() {
        xlmStorageReader = new XLMStorageReader();
    ...
    void successRead() {
        ...
        Map<String, Schema> schemas = xlmStorageReader.read(xmlContent);
    ...
    void storageMissingIdAttribute() {
        ...
        Throwable exception = assertThrows(PropertiesReaderException.class,
                () -> xlmStorageReader.read(xmlContent)
        );
