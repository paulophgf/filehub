    ...
    <tbody>
      ...
      <tr style="background-color: white; color: black">
        <td colspan="2">
            <div style="color: blue"><b>Properties:</b></div>
            <li>
                <b>jsonCredentials:</b> JSON object generated by account service 
                <br/>(APIs & Services > Credentials > Service Accounts > Keys) 
                <br/>Download the key, copy the JSON object and paste inside the jsonCredentials tag
            </li>
            <li><b>bucket:</b> storage bucket name</li>            
            <li><b>baseDir:</b> root directory</li>
        </td>
      </tr>
      <!--######################################################################################-->  
...
<p align="center">
    <img src="https://user-images.githubusercontent.com/32067860/209050316-bbdf04e2-5721-4b63-a143-4b812401a1a3.png" alt="drawing" width="80%"/>
</p>
<p align="center">
